...
# Evita que un consumidor sin credenciales repita la misma consulta y llene
# el log cuando el pool está vacío. El fichero compartido solo se activa en
...
class CredentialPool:
    ...
    def _select_unlocked(self, *, refresh: bool = True) -> Tuple[Optional[PooledCredential], List[tuple]]:
        ...
        # providers that return only the available-entry list.
