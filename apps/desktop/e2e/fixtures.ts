...
/**
 * Busca el binario Electron. En el devshell de Nix, `electron` está en PATH.
 * npm puede instalarlo en el workspace o elevarlo a la raíz del repositorio;
 * Windows usa además `electron.exe` y `where` en lugar de `which`.
 */
